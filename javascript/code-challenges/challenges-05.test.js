...
const addValues = (arr) => arr.reduce((acc, currVal) => acc += currVal, 0);
...
const addPurchases = (arr) => arr.reduce((acc, obj) => acc += obj.purchasePrice, 0);
// input: arr of objs
// output: total spent amount 
  // return arr.reduce(acc, obj.purchasePrice) => acc += obj.purchasePrice
...
const countNumberOfElements = (arr) => {
  ...
  return newArr.reduce((acc, currVal) => acc += currVal, 0);
}
...
// input: arr of obj
// output: arr of names
  // return arr.reduce(acc, obj) => acc += obj.name 
/* ------------------------------------------------------------------------------------------------
CHALLENGE 6
...
// output: reversed str
 // split str
 // decalre new arr
 // use for loop to push els into new arr backwards
 // return reduce on newarr 
