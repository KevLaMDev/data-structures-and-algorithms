...
// input: array 
// output: the same array passed in, with a copy of the first el pushed to the back
  // arr.push(arr[0])
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
const setStatusAsAuthor = (people) => people.forEach(obj => obj.isAuthor = true);
//input: arr of obj
// output: modify in place the obj, add new prop called isAuthor and set it to true
  // iterate thru the arr, can't use map, use forEach
